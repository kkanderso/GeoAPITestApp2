...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>phonegap-plugins/iOS/PowerManagement/PowerManagement.h at master · phonegap/phonegap-plugins</title>
...
<meta content="YfuVGcf6dWxdQLfDMtNJZunNLpfwcX5YXankyD0G7+M=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-7261477ac7d07d2f9ba3ff49c581c837335efeee.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="c5975ed6f883e205c23465d95d6dfc47">
        ...
        <link data-pjax-transient rel='permalink' href='/phonegap/phonegap-plugins/blob/4bf58f87efe0b26648d1f9dd073b7f50d250150c/iOS/PowerManagement/PowerManagement.h'>
...
<!-- blob contrib key: blob_contributors:v21:f36471e472539e527c1347419888ee88 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:f36471e472539e527c1347419888ee88 -->
...
<div class="select-menu js-menu-container js-select-menu" >
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/phonegap/phonegap-plugins/blob/master/iOS/PowerManagement/PowerManagement.h" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" data-skip-pjax="true" rel="nofollow" title="master">master</a>
            </div> <!-- /.select-menu-item -->
        </div>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/phonegap/phonegap-plugins/tree/init/iOS/PowerManagement/PowerManagement.h" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="init" data-skip-pjax="true" rel="nofollow" title="init">init</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/phonegap/phonegap-plugins/tree/PG141/iOS/PowerManagement/PowerManagement.h" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="PG141" data-skip-pjax="true" rel="nofollow" title="PG141">PG141</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/phonegap/phonegap-plugins/tree/BasicCLforIOS/iOS/PowerManagement/PowerManagement.h" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="BasicCLforIOS" data-skip-pjax="true" rel="nofollow" title="BasicCLforIOS">BasicCLforIOS</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/phonegap/phonegap-plugins/tree/AdPlugin-20100712/iOS/PowerManagement/PowerManagement.h" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="AdPlugin-20100712" data-skip-pjax="true" rel="nofollow" title="AdPlugin-20100712">AdPlugin-20100712</a>
            </div> <!-- /.select-menu-item -->
        </div>
  ...
  <div class="commit file-history-tease">
    <img class="main-avatar" height="24" src="https://1.gravatar.com/avatar/ab42fc6ffe0a711350de6dcca9f72752?d=https%3A%2F%2Fidenticons.github.com%2Fb8227b50b0780ed24fa173c4c3f28c17.png&amp;s=140" width="24" />
      ...
      <div class="actions">
        <div class="button-group">
                <a class="minibutton tooltipped leftwards"
                   ...
                   href="/phonegap/phonegap-plugins/edit/master/iOS/PowerManagement/PowerManagement.h"
                   data-method="post" rel="nofollow">Edit</a>
          <a href="/phonegap/phonegap-plugins/raw/master/iOS/PowerManagement/PowerManagement.h" class="button minibutton " id="raw-url">Raw</a>
            <a href="/phonegap/phonegap-plugins/blame/master/iOS/PowerManagement/PowerManagement.h" class="button minibutton ">Blame</a>
          <a href="/phonegap/phonegap-plugins/commits/master/iOS/PowerManagement/PowerManagement.h" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
            <a class="minibutton danger empty-icon tooltipped downwards"
               href="/phonegap/phonegap-plugins/delete/master/iOS/PowerManagement/PowerManagement.h"
...
<span id="L45" rel="#L45">45</span>
            ...
            <td class="blob-line-code">
                    <div class="highlight"><pre><div class='line' id='LC1'><span class="cm">/*</span></div><div class='line' id='LC2'><span class="cm"> * Copyright (C) 2011-2012 Wolfgang Koller</span></div><div class='line' id='LC3'><span class="cm"> * </span></div><div class='line' id='LC4'><span class="cm"> * This file is part of GOFG Sports Computer - http://www.gofg.at/.</span></div><div class='line' id='LC5'><span class="cm"> * </span></div><div class='line' id='LC6'><span class="cm"> * GOFG Sports Computer is free software: you can redistribute it and/or modify</span></div><div class='line' id='LC7'><span class="cm"> * it under the terms of the GNU General Public License as published by</span></div><div class='line' id='LC8'><span class="cm"> * the Free Software Foundation, either version 3 of the License, or</span></div><div class='line' id='LC9'><span class="cm"> * (at your option) any later version.</span></div><div class='line' id='LC10'><span class="cm"> * </span></div><div class='line' id='LC11'><span class="cm"> * GOFG Sports Computer is distributed in the hope that it will be useful,</span></div><div class='line' id='LC12'><span class="cm"> * but WITHOUT ANY WARRANTY; without even the implied warranty of</span></div><div class='line' id='LC13'><span class="cm"> * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the</span></div><div class='line' id='LC14'><span class="cm"> * GNU General Public License for more details.</span></div><div class='line' id='LC15'><span class="cm"> * </span></div><div class='line' id='LC16'><span class="cm"> * You should have received a copy of the GNU General Public License</span></div><div class='line' id='LC17'><span class="cm"> * along with GOFG Sports Computer.  If not, see &lt;http://www.gnu.org/licenses/&gt;.</span></div><div class='line' id='LC18'><span class="cm"> */</span></div><div class='line' id='LC19'><br/></div><div class='line' id='LC20'><span class="cm">/**</span></div><div class='line' id='LC21'><span class="cm"> * Cordova (iOS) plugin for accessing the power-management functions of the device</span></div><div class='line' id='LC22'><span class="cm"> */</span></div><div class='line' id='LC23'><br/></div><div class='line' id='LC24'><span class="cp">#ifdef CORDOVA_FRAMEWORK</span></div><div class='line' id='LC25'><span class="cp">#import &lt;CORDOVA/CDVPlugin.h&gt;</span></div><div class='line' id='LC26'><span class="cp">#else</span></div><div class='line' id='LC27'><span class="cp">#import &quot;CORDOVA/CDVPlugin.h&quot;</span></div><div class='line' id='LC28'><span class="cp">#endif</span></div><div class='line' id='LC29'><br/></div><div class='line' id='LC30'><span class="cm">/**</span></div><div class='line' id='LC31'><span class="cm"> * Interface which does the actual handling</span></div><div class='line' id='LC32'><span class="cm"> */</span></div><div class='line' id='LC33'><span class="k">@interface</span> <span class="nc">PowerManagement</span> :<span class="nc">CDVPlugin</span> <span class="p">{</span>    </div><div class='line' id='LC34'><span class="p">}</span></div><div class='line' id='LC35'><span class="cm">/**</span></div><div class='line' id='LC36'><span class="cm"> * Sets the idleTimerDisable property to true so that the idle timeout is disabled</span></div><div class='line' id='LC37'><span class="cm"> */</span></div><div class='line' id='LC38'><span class="o">-</span> <span class="p">(</span><span class="kt">void</span><span class="p">)</span> <span class="n">acquire</span><span class="o">:</span><span class="p">(</span><span class="n">NSMutableArray</span><span class="o">*</span><span class="p">)</span><span class="n">arguments</span> <span class="n">withDict</span><span class="o">:</span><span class="p">(</span><span class="n">NSMutableDictionary</span><span class="o">*</span><span class="p">)</span><span class="n">options</span><span class="p">;</span></div><div class='line' id='LC39'><br/></div><div class='line' id='LC40'><span class="cm">/**</span></div><div class='line' id='LC41'><span class="cm"> * Sets the idleTimerDisable property to false so that the idle timeout is enabled</span></div><div class='line' id='LC42'><span class="cm"> */</span></div><div class='line' id='LC43'><span class="k">-</span> <span class="p">(</span><span class="kt">void</span><span class="p">)</span> <span class="nf">release:</span><span class="p">(</span><span class="n">NSMutableArray</span><span class="o">*</span><span class="p">)</span><span class="nv">arguments</span> <span class="nf">withDict:</span><span class="p">(</span><span class="n">NSMutableDictionary</span><span class="o">*</span><span class="p">)</span><span class="nv">options</span><span class="p">;</span></div><div class='line' id='LC44'><br/></div><div class='line' id='LC45'><span class="k">@end</span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.06297s from github-fe118-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
